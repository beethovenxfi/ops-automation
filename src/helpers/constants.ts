...
export const SHEET_TAB_NAME_EMISSION = 'Emissions';
export const SHEET_RANGE_EMISSION = '!A2:J';
export const SHEET_TAB_NAME_BOUNTIES = 'Bounties';
export const SHEET_RANGE_BOUNTIES = '!A2:E';
...
export const SCATTER_CONTRACT_ADDRESS = '0xe907b1F554214129935820FDB8d7e771e1951d67';
