...
async function run(): Promise<void> {
    try {
        ...
        console.log(`Found ${Object.keys(recipientData).length} recipients for bounty disperse.`);
        console.log(`Total bounty tokens to disperse: ${Object.keys(totalBountyAmountsDisperse).length}`);
        console.log(`Total bounty tokens in sheet: ${Object.keys(totalBountyAmountsSheet).length}`);
        ...
        console.log(`Saving transaction batches now.`);
        ...
        for (const input of disperseInputs) {
            createTxnBatchForBountyDisperse(input);
        }
